...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/frontend_assets')}}/images/fav.ico" type="image/x-icon">
    <!-- GOOGLE FONT -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700%7CJosefin+Sans:600,700" rel="stylesheet">
    <!-- FONTAWESOME ICONS -->
    <!-- <link rel="stylesheet" href="{{asset('assets/frontend_assets')}}/font-awesome.min.css"> -->
    <link rel="stylesheet" href="{{asset('assets/frontend_assets')}}/css/font-awesome.min.css">
    <!-- ALL CSS FILES -->
    <link href="{{asset('assets/frontend_assets')}}/css/materialize.css" rel="stylesheet">
...
<body>
        ...
        <div id="modal1" class="modal fade" role="dialog">
            <div class="log-in-pop">
                ...
                <div class="log-in-pop-right">
                    <a href="#" class="pop-close" data-dismiss="modal"><img src="{{asset('assets/frontend_assets')}}/images/cancel.png" alt="" />
                    </a>
                    <h4>Login</h4>
                    <p>Don't have an account? Create your account. It's take less then a minutes</p>
                    <form class="s12">
    ...
    <script src="{{asset('assets/frontend_assets')}}/js/main.min.js"></script>
