                ...
                <div class="cor">
                    ...
                    <div class="col-md-6">
                        <div class="cor-mid-img">
                            <img src="{{asset('assets/frontend_assets')}}/images/course.jpg" alt="">
                            <!-- <img src="{{asset('assets/frontend_assets')}}/images/course.jpg" alt=""> -->
                        </div>
                        <div class="cor-con-mid">
                            ...
                            <div class="cor-p5">
                                ...
                                <ul class="nav nav-tabs">
									...
									<img src="{{asset('assets/frontend_assets')}}/images/icon/cor4.png" alt=""> <span>Requirements</span></a>
                                    </li>
                                    <li><a data-toggle="tab" href="#menu1"><img src="{{asset('assets/frontend_assets')}}/images/icon/cor3.png" alt=""><span>Fees</span></a></li>
                                    <li><a data-toggle="tab" href="#menu2"><img src="{{asset('assets/frontend_assets')}}/images/icon/cor1.png" alt=""><span>Student Profile</span></a></li>
                                    <li><a data-toggle="tab" href="#menu2"><img src="{{asset('assets/frontend_assets')}}/images/icon/cor5.png" alt=""><span>How to Apply</span></a></li>
                                </ul>
                            ...
                            <div class="cor-p6">
                                ...
                                <div class="cor-p6-revi">
                                    <div class="cor-p6-revi-left">
                                        <img src="{{asset('assets/frontend_assets')}}/images/4.jpg" alt="">
                                    </div>
