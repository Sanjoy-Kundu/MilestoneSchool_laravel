                    ...
                    <div class="ed-about-sec1">
                        <div class="ed-advan">
                            <ul>
                                <li>
                                    <div class="ed-ad-img">
                                        <img src="{{asset('assets/frontend_assets')}}/images/adv/1.png" alt="">
                                    </div>
                                    <div class="ed-ad-dec">
                                        <h4>Awards</h4>
                                ...
                                <li>
                                    <div class="ed-ad-img">
                                        <img src="{{asset('assets/frontend_assets')}}/images/adv/2.png" alt="">
                                    </div>
                                    <div class="ed-ad-dec">
                                        <h4>Research</h4>
                                ...
                                <li>
                                    <div class="ed-ad-img">
                                        <img src="{{asset('assets/frontend_assets')}}/images/adv/4.png" alt="">
                                    </div>
                                    <div class="ed-ad-dec">
                                        <h4>Alumni</h4>
                                ...
                                <li>
                                    <div class="ed-ad-img">
                                        <img src="{{asset('assets/frontend_assets')}}/images/adv/5.png" alt="">
                                    </div>
                                    <div class="ed-ad-dec">
                                        <h4>Facilities</h4>
                                        <p>Maecenas venenatis, turpis ac tincidunt convallis, leo enim ultrices tortor, at faucibus neque sapien ac elit. Curabitur ut ipsum odio.</p>
